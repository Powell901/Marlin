...
// Safety Features
  ...
  //#pragma message("Your Configuration provides no method to acquire user feedback! (Define NO_USER_FEEDBACK_WARNING to suppress this warning.)")
#endif
  ...
  #warning "Don't forget to update your TFT settings in Configuration.h."
    ...
    #pragma message("Double-check your 4.2.2 board for STM32 / GD32. Use BOARD_CREALITY_V422 or BOARD_CREALITY_V422_GD32_MFL as appropriate for your MCU.")
    #pragma message("GD32 Serial Ports are numbered starting from 0. STM32 Serial Ports are numbered starting from 1.")
    #pragma message("(Define NO_CREALITY_422_MCU_WARNING to suppress these warnings.)")
  #endif
