...
#if defined(EP_SERIAL_PORT) && defined(EMERGENCY_PARSER) && (EMERGENCY_PARSER)
  #define MYSERIAL1 EP_SERIAL_PORT(1)
#elif (SERIAL_PORT >= SERIAL_INDEX_MIN && SERIAL_PORT <= SERIAL_INDEX_MAX)
...
//
  ...
  #elif (SERIAL_PORT_2 >= SERIAL_INDEX_MIN && SERIAL_PORT_2 <= SERIAL_INDEX_MAX)
...
//
  ...
  #elif (SERIAL_PORT_3 >= SERIAL_INDEX_MIN && SERIAL_PORT_3 <= SERIAL_INDEX_MAX)
...
//
  ...
  #if (MMU_SERIAL_PORT >= SERIAL_INDEX_MIN && MMU_SERIAL_PORT <= SERIAL_INDEX_MAX)
...
//
  ...
  #if (LCD_SERIAL_PORT >= SERIAL_INDEX_MIN && LCD_SERIAL_PORT <= SERIAL_INDEX_MAX)
...
//
  ...
  #if (RS485_SERIAL_PORT >= SERIAL_INDEX_MIN && RS485_SERIAL_PORT <= SERIAL_INDEX_MAX)
